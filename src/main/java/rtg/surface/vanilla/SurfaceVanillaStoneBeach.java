...
public class SurfaceVanillaStoneBeach extends SurfaceBase
{
	...
	public SurfaceVanillaStoneBeach(IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceVanillaStoneBeach(IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
