...
public class SurfaceVanillaMegaTaiga extends SurfaceBase
{
	...
	public SurfaceVanillaMegaTaiga(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceVanillaMegaTaiga(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
