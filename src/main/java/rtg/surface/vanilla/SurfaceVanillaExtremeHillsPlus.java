...
public class SurfaceVanillaExtremeHillsPlus extends SurfaceBase
{
	...
	public SurfaceVanillaExtremeHillsPlus(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceVanillaExtremeHillsPlus(Block top, Block fill, boolean genBeach, Block genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
