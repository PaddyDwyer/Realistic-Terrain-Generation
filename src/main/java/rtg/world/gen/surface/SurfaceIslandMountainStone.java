...
public class SurfaceIslandMountainStone extends SurfaceBase
{
	...
	public SurfaceIslandMountainStone(IBlockState top, IBlockState fill, int beachHeight, IBlockState genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = beachHeight;
	...
	public SurfaceIslandMountainStone(IBlockState top, IBlockState fill, int beachHeight, IBlockState genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
