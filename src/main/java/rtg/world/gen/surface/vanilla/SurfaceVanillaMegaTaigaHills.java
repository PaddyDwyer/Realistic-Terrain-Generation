...
public class SurfaceVanillaMegaTaigaHills extends SurfaceBase
{
	...
	public SurfaceVanillaMegaTaigaHills(IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = genBeach;
	...
	public SurfaceVanillaMegaTaigaHills(IBlockState top, IBlockState fill, boolean genBeach, IBlockState genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
