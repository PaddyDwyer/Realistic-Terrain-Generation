...
public class SurfaceVanillaMushroomIsland extends SurfaceBase
{
	...
	public SurfaceVanillaMushroomIsland(IBlockState top, IBlockState fill, int beachHeight, IBlockState genBeachBlock, float minCliff) 
	{
		super(top, fill);
		beach = beachHeight;
	...
	public SurfaceVanillaMushroomIsland(IBlockState top, IBlockState fill, int beachHeight, IBlockState genBeachBlock, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff)
	{
