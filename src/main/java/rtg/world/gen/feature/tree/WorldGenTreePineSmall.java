...
public class WorldGenTreePineSmall extends WorldGenerator
{
	private int startHeight;
	private int treeSize;
	private int metadata;
	
	public WorldGenTreePineSmall(int start, int s)
	{
		this(start, s, 1);
	}
	
	public WorldGenTreePineSmall(int start, int s, int m)
	{
		startHeight = start;
		treeSize = s;
		metadata = m;
