...
{
    private IBlockState field_150519_a;
                ...
                if (d12 * d12 < 1.0D)
                {
                    for (int l2 = j1; l2 <= i2; ++l2)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            ...
                            {
                            	BlockPos newBlockPos = new BlockPos(k2, l2, i3);
                                double d14 = ((double)i3 + 0.5D - d8) / (d10 / 2.0D);
                                b = world.getBlockState(newBlockPos.down()).getBlock();;
                                
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && (b == Blocks.grass || b == Blocks.dirt || b == Blocks.sand || b == Blocks.gravel))
                                {
                                    world.setBlockState(newBlockPos, this.field_150519_a, 2);
                                }
                            }
                        }
                    }
